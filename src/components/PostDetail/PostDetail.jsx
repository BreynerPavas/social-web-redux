...
const PostDetail = () => {
    ...
    const onKeyUpHandler = (e) => {
            if(e.key === "Enter"){
                ...
                dispatch(addComment({idPost:id.id,body:e.target.value}))
            }
                   ...
                   <div class="cardbox shadow-lg bg-white">
                    ...
                    <div class="cardbox-base">
                     ...
                     <ul>
                      ...
                      <li><a><span>{post.likes?.length} Likes</span></a>
                      </li>
                    ...
                    <div class="cardbox-comments">
                     ...
                     <div class="search">
                        <form onSubmit={(e)=>{e.preventDefault()}}>
                             <input placeholder="Write a comment" type="text" onKeyUp={onKeyUpHandler}/>
                        </form>
